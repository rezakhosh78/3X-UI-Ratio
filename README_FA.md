...
**3X-UI Ratio** یک پنل مستقل برای مدیریت حجم کاربران نود است.

این برنامه فهرست کاربران را از API پنل 3X-UI هر نود دریافت می‌کند، حجم‌های تعریف‌شده را در دیتابیس مستقل خودش نگه می‌دارد و در صورت پایان حجم، کاربر را از طریق API رسمی 3X-UI غیرفعال می‌کند.
